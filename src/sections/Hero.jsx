...
const Hero = () => {
  ...
  return (
    ...
    justify-center min-h-screen sm:gap-10 gap-6 max-container
    border-1">
      <div className="relative xl:w-2/5 flex flex-col 
      justify-center items-start w-full max-xl:padding pt-28">
        <p className="py-2 text-xl font-montserrat text-coral-red">
        ...
        text-lg leading-8 mt-6 mb-10 sm:max-w-sm">
